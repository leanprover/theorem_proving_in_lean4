...
10]] Roughly, an element of =inhabited A= is simply a witness to the
fact that there is an element of =A=; in [[file:10_Type_Classes.org::#Type_Classes][Chapter 10]] we will see that
...
element, =arbitrary A=, of any inhabited type.
