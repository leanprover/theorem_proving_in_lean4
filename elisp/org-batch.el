       ...
       (let ((lang (org-element-property :language src-block))
         ...
         (if (not lang) (format "<pre class=\"example\"%s>\n%s</pre>" label code)
           (format
            ...
            (if lang
                (format "\n<juicy-ace-editor mode=\"ace/mode/%s\" readonly=\"true\">%s</juicy-ace-editor><div align=\"right\"><button type=\"button\" onclick=\"invoke_leanjs('%s');\">Try it yourself &raquo;</button></div>"
