...
calc
  a     = b      : h1
    ...
    ... =  e     : eq.symm h4
#+END_SRC
We will explain the expression =include h3= in the next chapter. The
...
# nice to do that example when we have left_distrib and right_distrib.
...
[[file:02_Dependent_Type_Theory.org::#Dependent_Types][Section 2.8]]. The difference is that given =a : A= and =h : p a=, the term
