...
law of the excluded middle follows from =strong_indefinite_description=
...
contradiction, all of which are described in Section [[file:03_Propositions_and_Proofs.org::#Classical_Logic][Classical Logic]].
