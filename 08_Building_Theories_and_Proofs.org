...
information, as discussed in Section [[file:05_Interacting_with_Lean.org::#Setting_Options][Setting Options]], using some or
...
discussed in Section [[file:09_Type_Classes.org::#Instances_in_Sections][Instances in Sections]] in the next chapter.
...
#+END_SRC
For example, =open [coercion] nat= makes the coercions in the
...
#+END_SRC
imports all metaclasses but =[notation]= and =[coercion]=. You can
